...
public class AddressServiceImpl implements AddressService {
	...
	public List<AddressDTO> getByState(String state) {
		List<Address> addresses = addressRepository.getByState(state);// get data using variable add store in list of
																		// address
		List<AddressDTO> addressDTOs = new ArrayList<AddressDTO>();// cerate new list of addressdto for storing listof
																	// data
